...
export default function MapControls({
    ...
    return (
        <div className="absolute top-4 right-4 z-10 flex flex-col gap-3 p-4 
                    bg-white/10 backdrop-blur-md border border-white/20 
                    rounded-xl shadow-xl text-white w-64">
            <h3 className="text-lg font-bold mb-2 text-white drop-shadow-md">Dashboard</h3>
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    onClick={() => onToggleTheme(currentTheme === 'day' ? 'night' : 'day')}
